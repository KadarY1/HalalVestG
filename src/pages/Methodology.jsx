  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">How HalalVest arrives at its screening results — fully transparent and configurable.</p>
      </div>
      ...
      <Card className="flex gap-3 border-amber-200 bg-amber-50 p-4">
        ...
        <p className="text-sm leading-relaxed text-amber-800">
          ...
          individual securities.</strong> HalalVest's prototype classifications should be treated as research outputs
      ...
      <Card className="p-6">
        ...
        <p className="text-sm leading-relaxed text-slate-600">
          Future versions of HalalVest could incorporate review from qualified Islamic finance scholars and a formal
